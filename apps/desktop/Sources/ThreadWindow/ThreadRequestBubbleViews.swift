...
struct ThreadPermissionBubbleView: View {
    let request: ThreadPermissionRequest
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: theme.spacing.sm) {
            ...
            HStack(spacing: theme.spacing.sm) {
                ...
                permissionButton("本 thread", decision: "allow", scope: "thread", accent: true)
...
struct ThreadWorkspaceAskBubbleView: View {
    let request: ThreadWorkspaceAskRequest
    let tab: ThreadTabViewModel
